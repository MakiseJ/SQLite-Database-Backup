...
CREATE TABLE `powers` (hero_id INTEGER, description VARCHAR (100), PRIMARY KEY (description, hero_id), FOREIGN KEY (hero_id) REFERENCES heroes(hero_id)) ;
...
INSERT INTO `planets` VALUES (13,'Krypton',NULL);
